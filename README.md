...
- 给主角一个具体目标，并把表面愿望剥到生存、饥饿、性、保护所爱之人、死亡恐惧等基本本能。
...
原书把“原始吗？”称为剧本创作和修改的试金石。它问的不是题材够不够低级或刺激，也不只是“大家能不能理解”，而是人物的表面目标能否继续向下追到最基本的本能驱动力：

```text
表面目标 → 为什么非得到不可 → 失败会失去什么 → 原始驱动力
```

原书直接给出的基准是：**生存、饥饿、性、保护所爱之人、死亡恐惧。**例如，升职本身不是原始驱动力；赢得爱人、为女儿筹手术费，才让它连到伴侣、保护所爱之人和死亡恐惧。复杂交易也不能因为“很重要”就算原始，必须继续追到人物是在保命、获得基本资源还是保护家人。

被爱、寻找伙伴、保护家园和正义复仇可以成为故事愿望，但仍要向下说明它触发了哪一种同等级的基本需要。跨文化观众容易理解，是原始驱动力产生的效果，不是“原始”的定义。
...
|---|---|---|---|
| `save-the-cat` | 从零完整创作，或要求把现有作品真正改好 | 守住创作主线，编排阶段，诊断后组织实际重写 | 完整创作进度或改稿后的作品 |
...
`save-the-cat` 不是没有创作判断的路由器。它负责确保每一阶段都在写同一个故事：
...
- 用户要求“强势改稿”或“把它改好”：`save-the-cat` 先诊断，再调用对应创作 skill 执行修改，不能把诊断建议丢给用户自己施工。
...
> 用 `save-the-cat` 强势改这个故事。先找最根本的问题，然后直接重写，不要只给建议。
